class Human : Character
{
    ...
    public Human(bool unlock, int quantityEnergy, int inventorySize, int inventoryWeight) : base(unlock, quantityEnergy, 10, inventorySize, inventoryWeight,  "Montagne", "Eau", 20,"Lignes droites")
    {
    }
